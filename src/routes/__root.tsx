  ...
  head: () => ({
    meta: [
      ...
      { title: "Sandeep Sharma — Software Engineer" },
      {
        name: "description",
        content:
          "Sandeep Sharma is a Java Software Engineer based in Kolkata, India — building fintech microservices, RESTful APIs and full-stack products at StyloPay.",
      },
      { name: "author", content: "Sandeep Sharma" },
      { property: "og:title", content: "Sandeep Sharma — Software Engineer" },
      {
        property: "og:description",
        content: "Java Software Engineer building fintech microservices and full-stack products.",
      },
